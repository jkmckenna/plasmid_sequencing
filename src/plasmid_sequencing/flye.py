...
def recursive_flye(input_dir, min_overlap=1000, nano_hq=False, nano_raw=0.1):
    """
    ...
    for root, _, files in os.walk(input_dir):
        ...
        for file in files:
            if file.endswith(".fastq") or file.endswith(".fastq.gz"):
                ...
                output_file = flye(input_file, min_overlap, nano_hq, nano_raw, output_dir=output_subdir)
