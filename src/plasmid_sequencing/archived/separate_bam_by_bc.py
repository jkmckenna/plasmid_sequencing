...
# General
def separate_bam_by_bc(input_bam, output_prefix='demultiplexed', bam_suffix='.bam', split_dir='demultiplexed_samples'):
    """
    ...
    root_dir = os.path.dirname(input_bam)
    split_dir = os.path.join(root_dir, split_dir)
    make_dirs([split_dir])

    print(f'Reading in {input_bam}')
